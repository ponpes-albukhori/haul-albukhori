...
export default function Home() {
  return (
    <div>
      <img
        className="absolute z-0 w-screen h-svh object-cover"
      ...
      <div className="relative flex flex-col justify-between z-10 bg-gradient-to-b from-[rgba(0,102,68,0.90)] to-[#032] h-svh  pt-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-center">
          <div className="text-white text-center drop-shadow-[0_4px_4px_rgba(0,0,0,1)]">
            <h1 className="font-bold text-[4em] tracking-[16px]">
              HAU<span className="tracking-normal">L</span>
            </h1>
            <h2 className="text-2xl tracking-[12px]">
              KE-XVI<span className="tracking-normal">I</span>
            </h2>
          </div>
          <div>
            <img
              className="w-64 mx-auto -mb-14 drop-shadow-[0_4px_4px_rgba(0,0,0,0.5)]"
              src="./images/abah_romo.png"
              alt="Abah Romo"
            />
            <div className="text-white text-center drop-shadow-[0_4px_4px_rgba(0,0,0,1)]">
              <h2 className="font-['Freehand'] text-2xl">
